 ...
 */
export const ProjectTaskGroups: React.FC<ProjectTaskGroupsProps> = ({
	project,
}) => {
	return (
		<Box sx={{ width: "100%" }}>
			...
			>
				...
				>
					Manage task groups for {project.name}
				</Typography>
			</Box>
			...
			>
				...
				>
					Task group management functionality will be available in a future
					update.
				</Typography>
			</Box>
		</Box>
