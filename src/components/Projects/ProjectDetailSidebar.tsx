      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <strong>Start Date:</strong> {project.startDate.toLocaleDateString()}
            </Typography>
            <Typography 
              variant="body2"
              sx={{
            ...
            >
              <strong>End Date:</strong> {project.endDate.toLocaleDateString()}
            </Typography>
          </Paper>
          ...
          >
            ...
            >
              Additional project information will be displayed here
            </Typography>
            <Typography 
              variant="caption" 
              color="text.disabled"
